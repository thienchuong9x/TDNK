<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sliderpanel.ascx.cs" Inherits="TDNK.Slider.panel.Sliderpanel" %>
 <!-- Caption Style -->
    <style> 
    ...
    <div id="slider2_container" style="position: relative; width: 960px;
        height: 300px;" class="fix_width">
